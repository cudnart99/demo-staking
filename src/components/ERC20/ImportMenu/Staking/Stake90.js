...
const Stake90 = ({ web3Staking, refreshDataGrid, tokenData }) => {
  ...
  const onClickApprove = async () => {
    ...
    try {
      ...
      await web3Staking.methods
        .stake90(amountToApprove)
        .send({ from: accounts[0] });
      successMessage = `Staking successful. ${data.arg2} tokenA in 90 seconds`;
