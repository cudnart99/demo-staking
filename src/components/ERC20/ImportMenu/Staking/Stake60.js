...
const Stake60 = ({ web3Staking, refreshDataGrid, tokenData }) => {
  ...
  const onClickApprove = async () => {
    ...
    try {
      ...
      await web3Staking.methods
        .stake60(amountToApprove)
        .send({ from: accounts[0] });
      successMessage = `Staking successful. ${data.arg2} tokenA in 60 seconds`;
